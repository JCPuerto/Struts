...
public class SearchForm extends ActionForm {
	...
	public ActionErrors validate(ActionMapping mapping, HttpServletRequest request) {
		...
		if (!nameEntered && !ssNumEntered) {
			...
			errors.add(ActionMessages.GLOBAL_MESSAGE, new ActionMessage("error.search.criteria.missing"));
		}
		...
		if (ssNumEntered && !isValidSsNum(ssNum.trim())) {
			//errors.add("ssNum", new ActionError("error.search.ssNum.invalid"));
